...
public class JobService {
    ...
    public JobService(){
        jobs = new ArrayList<>();
        jobs.add(new Job("a","bac si", "Bac si nha khoa", "Ha Noi", 400, 1000, "bacsi@gmail.com"));
        jobs.add(new Job("b","Kĩ sư", "Kĩ sư", "Hai Duong", 50, 500, "kisu@gmail.com"));
        jobs.add(new Job("c","lạp trình viên", "lap trinh", "Hai Phong", 100, 600, "laptrinh@gmail.com"));
        jobs.add(new Job("d","ke toan", "ke toan", "Ha Noi", 200, 700, "ketoan@gmail.com"));
    }
